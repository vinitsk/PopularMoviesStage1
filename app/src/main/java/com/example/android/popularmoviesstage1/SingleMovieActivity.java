...
public class SingleMovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView synopsisPlot = (TextView) findViewById(R.id.plot_synopsis);
        ...
        if (singleMovie.hasExtra("bundleValues")) {
            ...
            synopsisPlot.setText(bundleEntered.getString("plotSynopsis"));
            userRating.setText(bundleEntered.getString("userRating"));
